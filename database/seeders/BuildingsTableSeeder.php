...
class BuildingsTableSeeder extends Seeder
{
     ...
     *
     * Idempotent: skips if buildings already exist.
     */
    public function run()
    {
        if (Building::count() > 0) {
        ...
        Building::create([
            ...
            'end_level' => 10,
            'description' => ['en' => 'Produces the minerals.'],
            'mining_rate' => 600,
        ]);
        ...
        Building::create([
            ...
            'end_level' => 10,
            'description' => ['en' => 'Produces the energy and transmutes the minerals.'],
            'limit' => 1,
            'production_rate' => 400,
        ]);
        ...
        Building::create([
            ...
            'end_level' => 10,
            'description' => ['en' => 'Stores the drones.'],
            'supply' => 20000,
        ]);
        ...
        Building::create([
            ...
            'end_level' => 10,
            'description' => ['en' => 'Stores the minerals.'],
            'capacity' => 20000,
        ]);

        Building::create([
            'parent_id' => 3,
            'name' => ['en' => 'Sensor Tower'],
            'type' => Building::TYPE_SCOUT,
            'construction_experience' => 2163,
            'construction_cost' => 12362,
            'construction_time' => 216335,
            'end_level' => 10,
            'description' => ['en' => 'Detects the incoming and outgoing movements.'],
            'limit' => 1,
            'detection' => 600,
        ]);
